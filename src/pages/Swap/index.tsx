...
import {asSupportedChain, ChainId, isSupportedChain} from 'constants/chains'
  ...
  const allowance = usePermit2Allowance(
    maximumAmountIn ??
      (parsedAmounts[Field.INPUT]?.currency.isToken
        ...
        : undefined),
    isSupportedChain(chainId) ? (chainId === ChainId.SCROLL_SEPOLIA ? SWAP_ROUTER_ADDRESSES[chainId] : UNIVERSAL_ROUTER_ADDRESS(chainId)) : undefined,
    trade?.fillType
  )
